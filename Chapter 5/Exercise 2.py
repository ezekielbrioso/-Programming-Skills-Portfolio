...
glossary = {"Variable": "It is used to store values.","String": "A collection of characters.", "Arithmetic Operator": "A mathematical function that includes addition, subtraction, multiplication, division, and modulus.", "Loop": "A control structure that repeats multiple times until a condition is met.", "List": "A collection of values of different data types."}
